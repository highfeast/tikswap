...
import useProofVerifier from '@/hooks/useProofVerifier';
...
import { TikSwapClient } from '@/utils/TikSwapRPC';
...
function Component() {
    ...
    const { proof, loading: generatingLoading, nullifier, generateProof } = useProofGenerator();
